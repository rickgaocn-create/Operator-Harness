...
This agent exists because of the **{{ORG_G}} incident (2026-05-08)** — {{USER_NAME}} mentioned an entity and the main thread asked him to restate context that was already in `01 Wiki/`. That's the failure mode you prevent.
