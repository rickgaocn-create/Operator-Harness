---
name: inbox-process
description: Triage unprocessed files in 00 Raw/ and open tasks in 06 Tasks/Inbox.md — file content where it belongs, reschedule stale items, close what's done. Propose-then-execute discipline; never bulk-move on assumed intent. Trigger on "/inbox-process", "process my inbox", "clear inbox", "file my raw notes", "triage tasks", weekly Friday EOD review, or before /compress for a cleaner session log.
model: sonnet-4.6
