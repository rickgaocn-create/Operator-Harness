...
> **质量基线**：{{PERSON}} / 诸葛 / 路奇 / 任何 {{PROJECT_A}} / {{ORG_D}} / {{ORG_A}}内部读者读到时，**无明显英文残留**，无 chat-residue 风格。读起来像内部 BD 同事写的，不像 AI 生成。
...
- {{FUND}} / 国际投资人 audience 任意文档（Lane B 隔离）
...
- 目标读者全部中文 → 严格 monolingual + 称谓 {{USER_NAME}}
...
源 rule: [[MEMORY.md]] § Writing Principles · CN Output Monolingual + {{USER_NAME}} Name Rule
